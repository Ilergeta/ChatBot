...
def load_page(state, lucky_questions):
    ...
    st.markdown('<img style="float: right; width:1%, heigh:auto" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/International_Trade_Centre_Logo.svg/1200px-International_Trade_Centre_Logo.svg.png" />',
